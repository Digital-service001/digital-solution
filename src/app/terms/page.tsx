    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-slate-700">
        ...
        <div className="space-y-8 text-sm leading-relaxed border-t border-slate-200 pt-8">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">2. Products & Services Offered</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-2">3. Delivery & Fulfillment Timelines</h2>
            <p className="mb-2">
