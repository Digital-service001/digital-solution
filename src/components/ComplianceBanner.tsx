      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
        <div>
          <h4 className="text-slate-900 font-semibold text-sm">
            Merchant Compliance & Digital Fulfillment Transparency
          </h4>
          <p className="text-xs text-slate-600 mt-0.5">
            Every digital product is delivered instantly via automated email upon payment. Includes clean source files and commercial licensing.
          </p>
        </div>
